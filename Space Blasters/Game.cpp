...
void Game::InitializeText()
{
	...
	gamePausedText.setFillColor(sf::Color::Blue);
	...
	gameOverText.setPosition(
		...
		window->getSize().y / 2.f - gameOverText.getGlobalBounds().height - 35.f);
	...
	restartGameText.setPosition(
		window->getSize().x / 2.f - gameOverText.getGlobalBounds().width / 2.75f,
		window->getSize().y / 2.f - gameOverText.getGlobalBounds().height + 80.f);
}
...
void Game::InitializeWindow()
{
	...
	window = new sf::RenderWindow(videoMode, "Space Blasters", sf::Style::Close | sf::Style::Titlebar);
