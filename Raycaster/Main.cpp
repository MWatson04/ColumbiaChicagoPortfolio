...
void KeyPressedOpenGL(unsigned char key, int x, int y)
{
	engine.KeyPressed(key, x, y);
}

void KeyReleasedOpenGL(unsigned char key, int x, int y)
{
	engine.KeyReleased(key, x, y);
}
...
int main(int argc, char* argv[])
{
	...
	glutKeyboardFunc(KeyPressedOpenGL);
	glutKeyboardUpFunc(KeyReleasedOpenGL);
